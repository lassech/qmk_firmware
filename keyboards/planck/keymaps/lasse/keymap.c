...
[_QWERTY] = {
  ...
  {KC_LCTL, MO(_NORDIC), KC_LALT, KC_LGUI, LOWER,   KC_SPC,  MO(_NORDIC),  RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT}
},
...
[_NORDIC] = {
  {KC_TRNS, LECTIO, POSTBX1, POWERPOINT, WORD, KC_TRNS, KC_TRNS, KC_PGUP, KC_UP, KC_PGDN, KC_TRNS, KC_DEL },
  {KC_TRNS, KC_TRNS, MACRO1, MACRO2, MACRO3, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS},
